...
public class AlbumService extends BaseService<Album> {
    ...
    protected final MusicTrackRepository tracksRepository;
    ...
    public Page<Album> search(Map<String, String> filters, Pageable pageable) {
        return super.search(Album.class, filters, pageable);
    }
    ...
    public List<Album> saveAll(List<Album> albumList) {
        return super.saveAll(albumList);
    }
