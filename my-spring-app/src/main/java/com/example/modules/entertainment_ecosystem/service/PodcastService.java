...
public class PodcastService extends BaseService<Podcast> {
    ...
    protected final ArtistRepository hostRepository;
    
    protected final PodcastEpisodeRepository episodesRepository;
    
    protected final GenreRepository genresRepository;
    
    protected final UserProfileRepository listenersRepository;
    
    protected final PublisherRepository publisherRepository;
    
    protected final PodcastCategoryRepository categoriesRepository;
    
    protected final PodcastGuestRepository guestsRepository;
    ...
    public Page<Podcast> search(Map<String, String> filters, Pageable pageable) {
        return super.search(Podcast.class, filters, pageable);
    }
    ...
    public List<Podcast> saveAll(List<Podcast> podcastList) {
        return super.saveAll(podcastList);
    }
