...
public class ContentProviderService extends BaseService<ContentProvider> {
    ...
    protected final MovieRepository providedMoviesRepository;
    
    protected final TVShowRepository providedTvShowsRepository;
    
    protected final MusicTrackRepository providedMusicTracksRepository;
    
    protected final PodcastRepository providedPodcastsRepository;
    ...
    // Pagination simple
    public Page<ContentProvider> findAll(Pageable pageable) {
        return super.findAll(pageable);
    }

    // Recherche dynamique déléguée au BaseService (Specifications + pagination)
    public Page<ContentProvider> search(Map<String, String> filters, Pageable pageable) {
        return super.search(ContentProvider.class, filters, pageable);
    }
    ...
    public List<ContentProvider> saveAll(List<ContentProvider> contentproviderList) {
        return super.saveAll(contentproviderList);
    }
