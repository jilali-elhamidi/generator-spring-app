...
public class GameReviewService extends BaseService<GameReview> {
    ...
    protected final GameReviewCommentRepository commentsRepository;
    
    protected final GameReviewUpvoteRepository upvotesRepository;
    
    protected final GameReviewDownvoteRepository downvotesRepository;
    ...
    // Pagination simple
    public Page<GameReview> findAll(Pageable pageable) {
        return super.findAll(pageable);
    }

    // Recherche dynamique déléguée au BaseService (Specifications + pagination)
    public Page<GameReview> search(Map<String, String> filters, Pageable pageable) {
        return super.search(GameReview.class, filters, pageable);
    }
    ...
    public List<GameReview> saveAll(List<GameReview> gamereviewList) {
        return super.saveAll(gamereviewList);
    }
