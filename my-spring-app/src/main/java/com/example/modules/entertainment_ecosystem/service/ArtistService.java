...
public class ArtistService extends BaseService<Artist> {
    ...
    protected final UserProfileRepository favoriteArtistsRepository;
    
    protected final MusicTrackRepository composedMusicRepository;
    
    protected final AlbumRepository albumsRepository;
    
    protected final BookRepository booksAuthoredRepository;
    
    protected final LiveEventRepository participatedInEventsRepository;
    
    protected final PodcastRepository hostedPodcastsRepository;
    
    protected final MerchandiseRepository managedMerchandiseRepository;
    
    protected final VideoGameRepository managedGamesRepository;
    
    protected final ManagerRepository managerRepository;
    
    protected final ArtistAwardRepository awardsRepository;
    
    protected final MovieRepository actedInMoviesRepository;
    
    protected final MovieRepository directedMoviesRepository;
    
    protected final TVShowRepository directedShowsRepository;
    
    protected final DigitalAssetRepository managedAssetsRepository;
    
    protected final TVShowRepository actedInShowsRepository;
    
    protected final ArtistSocialMediaRepository socialMediaLinksRepository;
    
    protected final EpisodeCreditRepository episodeCreditsRepository;
    
    protected final AudiobookRepository authoredAudiobooksRepository;
    
    protected final MusicVideoRepository directedMusicVideosRepository;
    
    protected final ArtistGroupRepository groupsRepository;
    
    protected final TourRepository toursRepository;
    ...
    public Page<Artist> search(Map<String, String> filters, Pageable pageable) {
        return super.search(Artist.class, filters, pageable);
    }
    ...
    public List<Artist> saveAll(List<Artist> artistList) {
        return super.saveAll(artistList);
    }
