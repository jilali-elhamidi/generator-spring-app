...
public class VideoGameService extends BaseService<VideoGame> {
    ...
    protected final ReviewRepository generalReviewsRepository;
    
    protected final GameReviewRepository gameReviewsRepository;
    
    protected final UserProfileRepository playedByRepository;
    
    protected final GameAchievementRepository achievementsRepository;
    
    protected final GameSessionRepository sessionsRepository;
    
    protected final DevelopmentStudioRepository developerStudioRepository;
    
    protected final DigitalPurchaseRepository purchasesRepository;
    
    protected final GamePlatformRepository platformsRepository;
    
    protected final ContentRatingRepository contentRatingRepository;
    
    protected final ContentTagRepository tagsRepository;
    
    protected final VideoGameRatingRepository ratingsRepository;
    ...
    protected final GameExpansionPackRepository expansionPacksRepository;
    
    protected final LiveStreamRepository liveStreamsRepository;
    ...
    public Page<VideoGame> search(Map<String, String> filters, Pageable pageable) {
        return super.search(VideoGame.class, filters, pageable);
    }
    ...
    public List<VideoGame> saveAll(List<VideoGame> videogameList) {
        return super.saveAll(videogameList);
    }
