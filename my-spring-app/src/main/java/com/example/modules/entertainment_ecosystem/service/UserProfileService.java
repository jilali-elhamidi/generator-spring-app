...
public class UserProfileService extends BaseService<UserProfile> {
    ...
    protected final MovieRepository watchlistMoviesRepository;
    
    protected final ArtistRepository favoriteArtistsRepository;
    
    protected final UserProfileRepository followedUsersRepository;
    
    protected final UserProfileRepository followingUsersRepository;
    
    protected final GenreRepository favoriteGenresRepository;
    
    protected final SubscriptionRepository subscriptionsRepository;
    
    protected final EpisodeRepository watchedEpisodesRepository;
    
    protected final VideoGameRepository playedGamesRepository;
    
    protected final ForumThreadRepository forumThreadsRepository;
    
    protected final ForumPostRepository forumPostsRepository;
    
    protected final AchievementRepository achievementsRepository;
    
    protected final OnlineEventRepository hostedOnlineEventsRepository;
    
    protected final OnlineEventRepository attendedOnlineEventsRepository;
    
    protected final MerchandiseRepository ownedMerchandiseRepository;
    
    protected final PodcastRepository libraryPodcastsRepository;
    
    protected final MusicTrackRepository listenedMusicRepository;
    
    protected final PlaylistRepository playlistsRepository;
    
    protected final UserWalletRepository walletRepository;
    
    protected final DigitalPurchaseRepository digitalPurchasesRepository;
    
    protected final GameSessionRepository gameSessionsRepository;
    
    protected final GameReviewCommentRepository gameReviewCommentsRepository;
    
    protected final UserPlaylistRepository userPlaylistsRepository;
    
    protected final UserPlaylistItemRepository userPlaylistItemsRepository;
    
    protected final ReviewRatingRepository givenRatingsRepository;
    
    protected final ReviewLikeRepository likedReviewsRepository;
    
    protected final UserActivityLogRepository activityLogsRepository;
    
    protected final UserSettingRepository settingsRepository;
    
    protected final UserRoleRepository userRolesRepository;
    
    protected final UserFollowerRepository followersRepository;
    
    protected final UserFollowerRepository followingRepository;
    ...
    protected final MerchandiseReviewRepository merchandiseReviewsRepository;
    
    protected final UserPreferenceRepository preferencesRepository;
    
    protected final MerchandiseSaleRepository merchandiseSalesRepository;
    
    protected final GamePlaySessionRepository gamePlaySessionsRepository;
    
    protected final GameReviewUpvoteRepository gameReviewUpvotesRepository;
    
    protected final GameReviewDownvoteRepository gameReviewDownvotesRepository;
    
    protected final UserMessageRepository sentMessagesRepository;
    
    protected final UserMessageRepository receivedMessagesRepository;
    
    protected final FeatureFlagRepository enabledFeatureFlagsRepository;
    
    protected final MessageThreadRepository messageThreadsRepository;
    
    protected final UserLoyaltyProgramRepository loyaltyProgramRepository;
    
    protected final LiveStreamRepository hostedLiveStreamsRepository;
    
    protected final LiveStreamViewerRepository watchedLiveStreamsRepository;
    
    protected final UserBadgeRepository badgesRepository;
    
    protected final UserLevelRepository userLevelRepository;
    
    protected final UserRatingRepository givenUserRatingsRepository;
    
    protected final UserRatingRepository receivedUserRatingsRepository;
    
    protected final ForumModeratorRepository moderatorRepository;
    
    protected final UserConnectionRepository connectionsRepository;
    
    protected final UserConnectionRepository connectedByRepository;
    
    protected final UserBlockedListRepository blockedUsersRepository;
    
    protected final UserBlockedListRepository blockedByUsersRepository;
    
    protected final ReportedContentRepository reportedContentRepository;
    
    protected final ReviewReplyRepository reviewRepliesRepository;
    
    protected final EpisodeReviewRepository episodeReviewsRepository;
    
    protected final GameTransactionRepository gameTransactionsRepository;
    ...
    public Page<UserProfile> search(Map<String, String> filters, Pageable pageable) {
        return super.search(UserProfile.class, filters, pageable);
    }
    ...
    public List<UserProfile> saveAll(List<UserProfile> userprofileList) {
        return super.saveAll(userprofileList);
    }
