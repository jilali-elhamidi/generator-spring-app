...
public class ForumThreadService extends BaseService<ForumThread> {
    ...
    protected final ForumCategoryRepository categoryRepository;
    
    protected final ForumThreadTagRepository tagsRepository;
    ...
    public Page<ForumThread> search(Map<String, String> filters, Pageable pageable) {
        return super.search(ForumThread.class, filters, pageable);
    }
    ...
    public List<ForumThread> saveAll(List<ForumThread> forumthreadList) {
        return super.saveAll(forumthreadList);
    }
