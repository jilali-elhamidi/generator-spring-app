...
public class ReportedContentService extends BaseService<ReportedContent> {
    ...
    // Pagination simple
    public Page<ReportedContent> findAll(Pageable pageable) {
        return super.findAll(pageable);
    }

    // Recherche dynamique déléguée au BaseService (Specifications + pagination)
    public Page<ReportedContent> search(Map<String, String> filters, Pageable pageable) {
        return super.search(ReportedContent.class, filters, pageable);
    }
    ...
    public List<ReportedContent> saveAll(List<ReportedContent> reportedcontentList) {
        return super.saveAll(reportedcontentList);
    }
