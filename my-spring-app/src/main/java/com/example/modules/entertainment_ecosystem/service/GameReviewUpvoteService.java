...
public class GameReviewUpvoteService extends BaseService<GameReviewUpvote> {
    ...
    // Pagination simple
    public Page<GameReviewUpvote> findAll(Pageable pageable) {
        return super.findAll(pageable);
    }

    // Recherche dynamique déléguée au BaseService (Specifications + pagination)
    public Page<GameReviewUpvote> search(Map<String, String> filters, Pageable pageable) {
        return super.search(GameReviewUpvote.class, filters, pageable);
    }
    ...
    public List<GameReviewUpvote> saveAll(List<GameReviewUpvote> gamereviewupvoteList) {
        return super.saveAll(gamereviewupvoteList);
    }
