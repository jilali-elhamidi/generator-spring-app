...
public class EmployeeService extends BaseService<Employee> {
    ...
    protected final ShiftRepository shiftsRepository;
    
    protected final EventLocationRepository managedLocationsRepository;
    
    protected final EmployeeRoleRepository roleRepository;
    ...
    public Page<Employee> search(Map<String, String> filters, Pageable pageable) {
        return super.search(Employee.class, filters, pageable);
    }
    ...
    public List<Employee> saveAll(List<Employee> employeeList) {
        return super.saveAll(employeeList);
    }
