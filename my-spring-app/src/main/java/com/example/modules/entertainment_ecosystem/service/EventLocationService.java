...
public class EventLocationService extends BaseService<EventLocation> {
    ...
    protected final EmployeeRepository contactPersonRepository;
    ...
    public Page<EventLocation> search(Map<String, String> filters, Pageable pageable) {
        return super.search(EventLocation.class, filters, pageable);
    }
    ...
    public List<EventLocation> saveAll(List<EventLocation> eventlocationList) {
        return super.saveAll(eventlocationList);
    }
