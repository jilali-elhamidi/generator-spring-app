...
// === Relations ===
    ...
    @OneToMany(mappedBy = "baseGame", cascade = CascadeType.PERSIST, orphanRemoval = false, fetch = FetchType.LAZY)
        ...
        private List<GameExpansionPack> expansionPacks;
