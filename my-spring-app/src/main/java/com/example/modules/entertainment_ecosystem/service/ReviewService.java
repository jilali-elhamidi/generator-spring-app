...
public class ReviewService extends BaseService<Review> {
    ...
    protected final ReviewCommentRepository reviewCommentsRepository;
    
    protected final MediaFileRepository mediaFileRepository;
    
    protected final ReviewRatingRepository ratingsRepository;
    
    protected final ReviewLikeRepository likesRepository;
    ...
    public Page<Review> search(Map<String, String> filters, Pageable pageable) {
        return super.search(Review.class, filters, pageable);
    }
    ...
    public List<Review> saveAll(List<Review> reviewList) {
        return super.saveAll(reviewList);
    }
