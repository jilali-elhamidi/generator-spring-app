...
public class UserSettingService extends BaseService<UserSetting> {
    ...
    public Page<UserSetting> search(Map<String, String> filters, Pageable pageable) {
        return super.search(UserSetting.class, filters, pageable);
    }
    ...
    public List<UserSetting> saveAll(List<UserSetting> usersettingList) {
        return super.saveAll(usersettingList);
    }
