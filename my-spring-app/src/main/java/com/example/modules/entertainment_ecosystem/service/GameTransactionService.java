...
public class GameTransactionService extends BaseService<GameTransaction> {
    ...
    protected final GameCurrencyRepository currencyRepository;
    ...
    public Page<GameTransaction> search(Map<String, String> filters, Pageable pageable) {
        return super.search(GameTransaction.class, filters, pageable);
    }
    ...
    @Transactional
    public List<GameTransaction> saveAll(List<GameTransaction> gametransactionList) {
        return super.saveAll(gametransactionList);
    }
