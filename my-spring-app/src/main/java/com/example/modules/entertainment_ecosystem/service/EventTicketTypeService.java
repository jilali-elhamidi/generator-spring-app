...
public class EventTicketTypeService extends BaseService<EventTicketType> {
    ...
    // Pagination simple
    public Page<EventTicketType> findAll(Pageable pageable) {
        return super.findAll(pageable);
    }

    // Recherche dynamique déléguée au BaseService (Specifications + pagination)
    public Page<EventTicketType> search(Map<String, String> filters, Pageable pageable) {
        return super.search(EventTicketType.class, filters, pageable);
    }
    ...
    public List<EventTicketType> saveAll(List<EventTicketType> eventtickettypeList) {
        return super.saveAll(eventtickettypeList);
    }
