...
public class StreamingPlatformService extends BaseService<StreamingPlatform> {
    ...
    // Pagination simple
    public Page<StreamingPlatform> findAll(Pageable pageable) {
        return super.findAll(pageable);
    }

    // Recherche dynamique déléguée au BaseService (Specifications + pagination)
    public Page<StreamingPlatform> search(Map<String, String> filters, Pageable pageable) {
        return super.search(StreamingPlatform.class, filters, pageable);
    }
    ...
    public List<StreamingPlatform> saveAll(List<StreamingPlatform> streamingplatformList) {
        return super.saveAll(streamingplatformList);
    }
